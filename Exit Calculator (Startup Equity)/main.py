...
def cap_calc(x, y, z):
  ...
  print(f"Using a low-to-moderate risk investing strategy, your ROI from an inital sale of ${longterm:,.2f} (long-term) would gross ${roi:,.2f} on an annual rate of return at {arr:.0%}, and after 20% on long-term gains, a net of ${roi_lt:,.2f} per year after taxes.")
